...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.administration.languages.update', $language) }}" method="POST" enctype='multipart/form-data'>
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <label for="language_name" class="form-label mt-4">{{ __('Language') }}</label>
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Language') }}"
                                name="language_name" id="language_name" aria-label="language_name"
                                aria-describedby="language_name"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Language Code') }}"
                                name="language_code" id="language_code"
                        ...
                        <div class="d-flex mt-2">
                            <div class="form-check form-switch me-4">
                                <input class="form-check-input" name="system_language_status" type="checkbox"
                                    ...
                                    @if (old('system_language_status', $language->system_language_status) == 1) checked @endif>
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" name="tongue_language_status" type="checkbox"
                                    ...
                                    @if (old('tongue_language_status', $language->tongue_language_status) == 1) checked @endif>
                                <label class="form-check-label"
