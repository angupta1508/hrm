...
@section('content')
    <div class="card card-default">
        ...
        <div class="card-body">
            <form action="{{ route('admin.leave.holidays.update', $holiday) }}" method="POST" enctype='multipart/form-data'>
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Holiday Name') }}"
                                name="holiday_name" id="holiday_name"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="date" class="form-control" placeholder="{{ __('Date') }}" name="date"
                                id="date" value="{{ old('date', $holiday->date) }}">
                            @error('date')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <!-- <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Holiday Type') }}"
                                name="holiday_type" id="holiday_type"
                                value="{{ old('holiday_type', $holiday->holiday_type) }}">
                            @error('holiday_type')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
