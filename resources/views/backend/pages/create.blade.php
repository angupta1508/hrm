            ...
            <form action="{{ route('admin.cms.pages.store') }}" method="POST">
                ...
                <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <input type="text" class="form-control"
                                    ...
                                    name="page_name[{{ $key }}]"
                                    value="{{ !empty($language_pages[$key]->page_name) ? $language_pages[$key]->page_name : '' }}">
                                @error('page_name[{{ $key }}]')
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="">
                                <input type="text" class="form-control"
                                    ...
                                    name="page_meta_title[{{ $key }}]"
                                    value="{{ !empty($language_pages[$key]->page_meta_title) ? $language_pages[$key]->page_meta_title : '' }}">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Page Meta Key') }}" name="page_meta_key" value="{{ old('page_meta_key') }}">
                            @error('page_meta_key')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <textarea class="form-control" name="page_meta_description">{{ old('page_meta_description') }}</textarea>
