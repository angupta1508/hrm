                    ...
                    <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                        <div class="card mt-8">
                            <div class="card-header pb-0 text-center bg-transparent">
                                <?php $setdata = Config::get('back_website_logo'); ?>
                                <img src="{{ url(config('constants.setting_image_path').$setdata) }}"
                            ...
                            <div class="card-body">
                                <form role="form text-left" method="POST" action="{{ route('admin.registerStore') }}">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <p class="text-sm mt-3 mb-0">Already have an account? <a
                                            href="{{ route('admin.login') }}" class="text-dark font-weight-bolder">Sign
                                            in</a></p>
                                </form>
                            </div>
                        </div>
