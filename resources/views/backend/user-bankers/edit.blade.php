...
@section('content')
    <div class="card card-default">
        ...
        <div class="card-body">
            <form action="{{ route('admin.user-bankers.update', $user_banker) }}" method="POST" enctype='multipart/form-data'>
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="">
                            {{ Form::select('bank_id', ['' => __('Select Bank')] + $bank_list, old('bank_id', $user_banker->bank_id), ['class' => 'form-select']) }}
                            @error('bank_id')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            {{ Form::select('user_id', ['' => __('Select User')] + $user_list, old('user_id', $user_banker->user_id), ['class' => 'form-select select2']) }}
                            @error('user_id')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Account Number') }}"
                                name="account_no" id="account_no" value="{{ old('account_no', $user_banker->account_no) }}">
                            @error('account_no')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            {{ Form::select('account_type', ['' => __('Select Account Type')] + getListTranslate(config('constants.account_type')), old('account_type', $user_banker->account_type), ['class' => 'form-select']) }}
                            @error('account_type')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('IFSC Code') }}"
                                name="ifsc_code" id="ifsc_code" value="{{ old('ifsc_code', $user_banker->ifsc_code) }}">
                            @error('ifsc_code')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Account Holder Name') }}"
                                name="account_name" id="account_name" value="{{ old('account_name', $user_banker->account_name) }}">
                            @error('account_name')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
