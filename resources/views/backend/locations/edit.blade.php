    ...
    <div class="card card-default">
        <div class="card-header pb-0">
            <div class="d-flex flex-row justify-content-between">
                <div>
                    <h5 class="mb-0">
                        {{ __('Edit New Location') }}
                    </h5>
                </div> 
            </div>  
        </div> 
        <div class="card-body">
            <form action="{{ route('admin.administration.locations.update', $location) }}" method="POST" enctype='multipart/form-data'>
                @method('PUT')
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Location Name') }}" name="location_name"
                                id="location_name" value="{{ old('location_name', $location->location_name) }}">
                            @error('location_name')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Latitude') }}" name="latitude"
                                id="latitude" value="{{ old('latitude', $location->latitude) }}">
                            @error('latitude')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Longitude') }}" name="longitude"
                                id="longitude" value="{{ old('longitude', $location->longitude) }}">
                            @error('longitude')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('IP') }}" name="ip"
                                id="ip" value="{{ old('ip',$location->ip) }}">
                            @error('ip')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Location Name') }}" name="acceptable_range"
                                id="acceptable_range" value="{{ old('acceptable_range', $location->acceptable_range) }}">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="">
                            {{ Form::select('weekly_holiday', ['' => __('Select Weekly Holiday')] + getListTranslate(config('constants.default_weekly_holiday')), old('weekly_holiday', $location->weekly_holiday), ['class' => 'form-select']) }}                            
