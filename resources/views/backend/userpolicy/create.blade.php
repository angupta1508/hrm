...
@section('content')
    <div class="card card-default">
        ...
        <div class="card-body">
            <form action="{{ route('admin.administration.user-policy.store') }}" method="POST" enctype='multipart/form-data'>
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="">
                            <input type="text" class="form-control" placeholder="{{ __('Policy Name') }}"
                                name="policy_name" id="policy_name" value="{{ old('policy_name') }}">
                            @error('policy_name')
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('eneble_working_hours_relaxation') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Fullday Relaxation') }}"
                                name="fullday_relaxation" id="fullday_relaxation" value="{{ old('fullday_relaxation') }}">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Halfday Relaxation') }}"
                                name="halfday_relaxation" id="halfday_relaxation" value="{{ old('halfday_relaxation') }}">
                            <small class="fw-bold">(Time in Minutes)</small>
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('eneble_late_coming') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Late Coming Relaxation') }}"
                                ...
                                value="{{ old('late_coming_relaxation') }}">
                            <small class="fw-bold">(Time in Minutes)</small>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control"
                                ...
                                value="{{ old('late_coming_deduction_repeate') }}">
                ...
                <div class="row">
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('eneble_early_going') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Early Going Relaxation') }}"
                                name="early_going_relaxation" id="early_going_relaxation"
                                value="{{ old('early_going_relaxation') }}">
                            <small class="fw-bold">(Time in Minutes)</small>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control"
                                ...
                                value="{{ old('early_going_deduction_repeate') }}">
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('eneble_holiday_working_hours') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Holiday Working Hours') }}"
                                ...
                                value="{{ old('holiday_working_hours') }}">
                            <small class="fw-bold">(Time in Minutes)</small>
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('eneble_weekoff_working_hours') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('WeekOff Working Hours') }}"
                                ...
                                value="{{ old('weekoff_working_hours') }}">
                            <small class="fw-bold">(Time in Minutes)</small>
                ...
                <div class="row">
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('eneble_weekday_for_weekend') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            {{ Form::select('weekday_for_weekend', ['' => __('Select Week Day')] + getListTranslate(config('constants.weekend')), old('weekday_for_weekend'), ['class' => 'form-control']) }}
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('eneble_overtime_working_day') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Overtime Apply Time') }}"
                                name="overtime_apply_time" value=" {{ old('overtime_apply_time') }}">
                            <small class="fw-bold">(Time in Minutes)</small>
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Medical Leave') }}"
                                name="medical_leave" id="medical_leave" value="{{ old('medical_leave') }}">
                            @error('medical_leave')
                                <p class="text-danger text-xs mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Paternity Leave') }}"
                                name="paternity_leave" id="paternity_leave" value="{{ old('paternity_leave') }}">
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Maternity Leave') }}"
                                name="maternity_leave" id="maternity_leave" value="{{ old('maternity_leave') }}">
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="">
                            <input type="number" class="form-control" placeholder="{{ __('Every Month Paid Leave') }}"
                                ...
                                value="{{ old('every_month_paid_leave') }}">
                ...
                <div class="row">
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('carry_forward_month') == '1' ? 'checked' : '' }}>
                            </div>
                        ...
                        <div class="">
                            <div class="form-check form-switch d-inline-block">
                                <input class="form-check-input mt-2" type="checkbox" role="switch"
                                    ...
                                    {{ old('carry_forward_year') == '1' ? 'checked' : '' }}>
                            </div>
                    ...
                    <div class="col-md-4 mt-3">
                        ...
                        <div class="">
                            {{ Form::select('carry_forward_till_month', ['' => __('Select Month')] + getListTranslate(config('constants.month_name')), old('carry_forward_till_month'), ['class' => 'form-control']) }}
